...
pygame.display.set_caption('THE UNDEAD MENACE')
...
def info_show():
        ...
        draw_text('In this you have to survive the zombie', LORE, WHITE, 680, 350)
...
while run:
    ...
    if start_game == False:
        ...
        draw_text('The Undead Menace', gametitle, WHITE, 180, 125)
        ...
        if info_button.draw(screen):
            MENUSELECT.play()
            webbrowser.open('https://github.com/923aryan/pygame_UNDEAD_MENACE')
            webbrowser.open('https://github.com/923aryan/pygame_UNDEAD_MENACE')
    else:
        draw_bg()
        world.draw()
